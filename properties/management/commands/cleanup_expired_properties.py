...
from properties.utils import expire_featured_and_publications
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write('Cleanup Expired Properties Command')
        self.stdout.write(f'{"=" * 60}')
        ...
        if not dry_run:
            ...
            self.stdout.write('Expired featured flags and publication windows cleared')
        ...
        self.stdout.write(
            f'\nFound {properties_to_delete.count()} properties to delete '
            f'(frozen for > {days_threshold} days)'
        )
